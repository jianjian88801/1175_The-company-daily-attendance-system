<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="请假扣除" prop="qingjiakouchu">
          <el-input v-model="ruleForm.qingjiakouchu" 
              placeholder="请假扣除" clearable  :readonly="ro.qingjiakouchu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="请假扣除" prop="qingjiakouchu">
              <el-input v-model="ruleForm.qingjiakouchu" 
                placeholder="请假扣除" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="迟到早退扣除" prop="chidaozaotuikouchu">
          <el-input v-model="ruleForm.chidaozaotuikouchu" 
              placeholder="迟到早退扣除" clearable  :readonly="ro.chidaozaotuikouchu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="迟到早退扣除" prop="chidaozaotuikouchu">
              <el-input v-model="ruleForm.chidaozaotuikouchu" 
                placeholder="迟到早退扣除" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="旷工扣除" prop="kuanggongkouchu">
          <el-input v-model="ruleForm.kuanggongkouchu" 
              placeholder="旷工扣除" clearable  :readonly="ro.kuanggongkouchu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="旷工扣除" prop="kuanggongkouchu">
              <el-input v-model="ruleForm.kuanggongkouchu" 
                placeholder="旷工扣除" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="扣款原因" prop="koukuanyuanyin">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.koukuanyuanyin" label="扣款原因" prop="koukuanyuanyin">
                    <span>{{ruleForm.koukuanyuanyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	jiabangongzi : false,
	qingjiakouchu : false,
	chidaozaotuikouchu : false,
	kuanggongkouchu : false,
  ...
  computed: {
    shifagongzi: {
      get: function () {
        return 0+parseFloat(this.ruleForm.jibengongzi==""?0:this.ruleForm.jibengongzi)+parseFloat(this.ruleForm.jiabangongzi==""?0:this.ruleForm.jiabangongzi)-parseFloat(this.ruleForm.qingjiakouchu==""?0:this.ruleForm.qingjiakouchu)-parseFloat(this.ruleForm.chidaozaotuikouchu==""?0:this.ruleForm.chidaozaotuikouchu)-parseFloat(this.ruleForm.kuanggongkouchu==""?0:this.ruleForm.kuanggongkouchu) || 0
      }
    },
  },
  created() {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiabangongzi = true;
          ...
          if(o=='qingjiakouchu'){
            this.ruleForm.qingjiakouchu = obj[o];
	    this.ro.qingjiakouchu = true;
            continue;
          }
          if(o=='chidaozaotuikouchu'){
            this.ruleForm.chidaozaotuikouchu = obj[o];
	    this.ro.chidaozaotuikouchu = true;
            continue;
          }
          if(o=='kuanggongkouchu'){
            this.ruleForm.kuanggongkouchu = obj[o];
	    this.ro.kuanggongkouchu = true;
            continue;
          }
          if(o=='koukuanyuanyin'){
