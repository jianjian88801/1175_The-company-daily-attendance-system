    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="部门介绍" prop="bumenjieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.bumenjieshao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.bumenjieshao" label="部门介绍" prop="bumenjieshao">
                    <span v-html="ruleForm.bumenjieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.bumenjieshao = this.ruleForm.bumenjieshao.replace(reg,'../../../springbootqi5ww/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
