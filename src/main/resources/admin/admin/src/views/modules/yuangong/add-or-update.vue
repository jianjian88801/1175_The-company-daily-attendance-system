<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="个人职位" prop="gerenzhiwei">
          <el-input v-model="ruleForm.gerenzhiwei" 
              placeholder="个人职位" clearable  :readonly="ro.gerenzhiwei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="个人职位" prop="gerenzhiwei">
              <el-input v-model="ruleForm.gerenzhiwei" 
                placeholder="个人职位" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="在职情况" prop="zaizhiqingkuang">
          <el-select v-model="ruleForm.zaizhiqingkuang" placeholder="请选择在职情况">
            <el-option
                v-for="(item,index) in zaizhiqingkuangOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="在职情况" prop="zaizhiqingkuang">
	      <el-input v-model="ruleForm.zaizhiqingkuang"
                placeholder="在职情况" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.bumen = true;
          ...
          if(o=='gerenzhiwei'){
            this.ruleForm.gerenzhiwei = obj[o];
	    this.ro.gerenzhiwei = true;
            continue;
          }
          if(o=='zaizhiqingkuang'){
            this.ruleForm.zaizhiqingkuang = obj[o];
	    this.ro.zaizhiqingkuang = true;
            continue;
          }
          if(o=='tupian'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.zaizhiqingkuangOptions = "在职,离职".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
