<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="考勤基点" prop="kaoqinjidian">
          <el-select v-model="ruleForm.kaoqinjidian" placeholder="请选择考勤基点">
            <el-option
                v-for="(item,index) in kaoqinjidianOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="考勤基点" prop="kaoqinjidian">
	      <el-input v-model="ruleForm.kaoqinjidian"
                placeholder="考勤基点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.leixing = true;
          ...
          if(o=='kaoqinjidian'){
            this.ruleForm.kaoqinjidian = obj[o];
	    this.ro.kaoqinjidian = true;
            continue;
          }
          if(o=='kaoqinshijian'){
