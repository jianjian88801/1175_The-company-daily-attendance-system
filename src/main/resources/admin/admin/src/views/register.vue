  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(104, 223, 240, 1);fontSize:28px;">公司日常考勤系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='yuangong'" class="input-group">
			   <div class="label">个人职位</div>
			   <div class="input-container">
			     <input v-model="ruleForm.gerenzhiwei" class="input" type="text" placeholder="个人职位">
			   </div>
			 </div> -->
			<el-form-item label="个人职位" class="input" v-if="tableName=='yuangong'">
			  <el-input v-model="ruleForm.gerenzhiwei" autocomplete="off" placeholder="个人职位"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yuangong'" class="input-group">
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if((!this.ruleForm.nianling) && `yuangong` == this.tableName){
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210411/a79cf132d6bd4b0cbc8301d615d4e3e9.jpg");
		height: 100vh;
